...
public class BooleanBitwiseOperator {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("~A = " + Integer.toBinaryString(~A));//1111111111111111111101100101101
        System.out.println("-A = " + Integer.toBinaryString(-A));//1111111111111111111101100101110
        System.out.println("-A >> 4 = " + Integer.toBinaryString(-A >> 4));//1111111111111111111111110110010
        System.out.println("-A >>> 4 = " + Integer.toBinaryString(-A >>> 4));//111111111111111111110110010
